...
//TODO: 3. Create a variable named (h1), using the (body) variable from above use the property (firstElementChild) to assign the h1 element to the (h1) variable.

//* add the code here
const h1 = body.firstElementChild;

// log the h1 variable to see the result
console.log(h1);
...
// Log the ul variable to see the result
console.log(ul);
